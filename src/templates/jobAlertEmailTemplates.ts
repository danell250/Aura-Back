export const renderJobAlertsWelcomeEmailTemplate = (params: {
  categoryLabelHtml: string;
  jobsUrlHtml: string;
...
export const renderJobAlertDigestEmailTemplate = (params: {
  safeRecipientName: string;
  headlineHtml: string;
  subheadlineHtml: string;
  rowsHtml: string;
  ctaUrlHtml: string;
  ctaLabelHtml: string;
  manageLinkHtml?: string;
}): string => `
