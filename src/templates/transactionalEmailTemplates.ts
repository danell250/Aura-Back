export const renderMagicLinkEmailTemplate = (params: {
...
export const renderCompanyInviteEmailTemplate = (params: {
  companyNameHtml: string;
  inviteUrlHtml: string;
}): string => `
...
export const renderJobApplicationReviewEmailTemplate = (params: {
  reviewerNameHtml: string;
  companyNameHtml: string;
  jobTitleHtml: string;
  applicantNameHtml: string;
  applicantEmailHtml: string;
  applicantPhoneHtml: string;
  submittedAtHtml: string;
  expiresRowHtml: string;
  securePortalUrlHtml: string;
}): string => `
...
export const renderReverseJobMatchDigestEmailTemplate = (params: {
  jobsCount: number;
  recipientNameHtml: string;
  rowsHtml: string;
  shareLinkHtml: string;
}): string => `
