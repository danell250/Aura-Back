export const renderReportPreviewEmailTemplate = (params: {
  periodLabelHtml: string;
  scopeLabelHtml: string;
  shouldAttachPdf: boolean;
  executiveSummaryRowsHtml: string;
  visualsSectionHtml: string;
  topSignalsSectionHtml: string;
  campaignDataSectionHtml: string;
  recommendationsSectionHtml: string;
}): string => `
