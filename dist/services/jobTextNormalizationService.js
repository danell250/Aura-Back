...
exports.normalizeJobText = void 0;
...
const decodeNumericHtmlEntity = (_match, entityBody) => {
...
const decodeBasicHtmlEntities = (value) => value
    .replace(HTML_ENTITY_REGEX, (entity) => { var _a; return (_a = HTML_ENTITY_MAP[entity.toLowerCase()]) !== null && _a !== void 0 ? _a : entity; })
...
const normalizeJobText = (value, maxLength = 15000) => {
    const raw = (0, inputSanitizers_1.readString)(value, maxLength);
    if (!raw)
        return '';
    let normalized = raw;
...
exports.normalizeJobText = normalizeJobText;
