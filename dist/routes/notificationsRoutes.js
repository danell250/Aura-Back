...
router.get('/user/:userId', notificationsController_1.notificationsController.getNotificationsByUser);
...
router.put('/user/:userId/read-all', notificationsController_1.notificationsController.markAllAsRead);
