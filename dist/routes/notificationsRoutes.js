...
router.get('/user/:userId', authMiddleware_1.requireAuth, (0, authMiddleware_1.requireOwnership)(), notificationsController_1.notificationsController.getNotificationsByUser);
...
router.put('/user/:userId/read-all', authMiddleware_1.requireAuth, (0, authMiddleware_1.requireOwnership)(), notificationsController_1.notificationsController.markAllAsRead);
