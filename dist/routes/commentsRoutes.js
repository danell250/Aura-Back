...
router.put('/comments/:id', commentsController_1.commentsController.updateComment);
// DELETE /api/comments/:id - Delete comment
router.delete('/comments/:id', commentsController_1.commentsController.deleteComment);
// POST /api/comments/:id/react - Add reaction to comment
router.post('/comments/:id/react', commentsController_1.commentsController.reactToComment);
