...
const openToWorkProfileService_1 = require("../services/openToWorkProfileService");
...
const ALLOWED_OPEN_TO_WORK_MODELS = new Set(['remote', 'hybrid', 'onsite']);
const sanitizeStringList = (value, maxItems, maxLength) => {
...
const sanitizeWorkModelPreferences = (value) => {
...
exports.usersController = {
    ...
    getFeaturedPosts: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const { id } = req.params;
            const authUserId = String(((_a = req.user) === null || _a === void 0 ? void 0 : _a.id) || '').trim();
        ...
        try {
            ...
            if (normalizedFeaturedPostIds.length > 0) {
                const ownedPosts = yield db.collection('posts')
                    ...
                    .project({ id: 1, ownerType: 1, 'author.id': 1 })
                    .toArray();
                const ownsEveryPost = ownedPosts.length === normalizedFeaturedPostIds.length
                    && ownedPosts.every((post) => { var _a; return String(((_a = post === null || post === void 0 ? void 0 : post.author) === null || _a === void 0 ? void 0 : _a.id) || '') === authUserId; })
                    && ownedPosts.every((post) => {
                        const ownerType = String((post === null || post === void 0 ? void 0 : post.ownerType) || '').trim().toLowerCase();
    ...
    getUserById: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (user) {
                ...
                const openToWorkFields = yield (0, openToWorkProfileService_1.buildOpenToWorkProfileResponse)({
                    db,
                    user,
                    isSelf,
                });
                return res.json({
                    success: true,
                    type: 'user',
                    data: Object.assign(Object.assign(Object.assign({}, (isSelf ? transformed : sanitizePublicUserProfile(transformed))), openToWorkFields), { type: 'user' })
                });
            }
            // Try to find company
    ...
    getUserByHandle: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const db = (0, db_1.getDB)();
            const normalizedHandle = escapeRegex(handle);
            // Try to find user first
    ...
    updateUser: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (normalizedFirstName !== null || normalizedLastName !== null) {
                ...
                const nextLastName = normalizedLastName !== null && normalizedLastName !== void 0 ? normalizedLastName : (typeof existingUser.lastName === 'string' ? existingUser.lastName.trim() : '');
            ...
            if (typeof mutableUpdates.handle === 'string') {
                ...
                const existingNormalizedHandle = normalizeUserHandle(typeof existingUser.handle === 'string' ? existingUser.handle : '');
        ...
        try {
            ...
            if (!authUserId || authUserId !== id) {
                return res.status(403).json({
                    success: false,
                    error: 'Forbidden',
                    message: 'You can only view your own serendipity matches'
                });
            }
